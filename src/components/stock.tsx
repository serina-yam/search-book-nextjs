...
import ModalComponent from './AlertModal'
...
export default function Stock({
  ...
  return (
    <>
      ...
      <ModalComponent isOpen={modalOpen} onClose={() => setModalOpen(false)} onDelete={handleDelete} userId={userId} isbn={isbn} />
    </>
  )
}
